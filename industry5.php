...
<body>
  ...
  <div class="breadcrumb-area bg-img bg-overlay jarallax" style="background-image: url('images/in555.jpg');">
          ...
          <div class="news-details-content">
           ...
           <p>Consumer goods can be broadly categorized as durable or nondurable, and the overall consumer goods sector can be broken down across many different industries. While some product types, such as food, are necessary, others, such as automobiles, are considered luxury items. In general, when the economy is growing, consumer demand grows and the sector will see an increased demand for higher-end products. When consumer demand shrinks, there is an increased relative demand for value products.</p>
            ...
            <p>– The Union Cabinet has given its nod for the amendment of the existing Foreign Direct Investment (FDI) policy in the pharmaceutical sector in order to allow FDI up to 100 per cent under the automatic route for manufacturing of medical devices subject to certain conditions.</p>
              ...
              <div class="col-lg-8">
                <img class="w-100 mb-30" src="images/in55.jpg" style="width:600px; height:420px" alt="">
              </div>          
